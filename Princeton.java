...
/**
 * 
 * This class creates the Princeton enemy
 *
 */
public class Princeton extends GameObject {
	public static final String IMG_FILE = "files/princeton.png";
    ...
    public Princeton(int courtWidth, int py) {
